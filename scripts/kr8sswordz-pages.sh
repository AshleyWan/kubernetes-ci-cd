...
docker stop socat-registry; docker rm socat-registry; docker run -d -e "REG_IP=`sudo minikube ip`" -e "REG_PORT=30400" --name socat-registry -p 30400:5000 socat-registry
